...
logger = logging.getLogger('raidforums_slave5')


class RaidforumsSlave5Spider(RaidforumsSpider): # Category: RaidForums>OnlineAccounts>Social Media

    name = 'raidforumsslave5'
    custom_settings = {
        'DOWNLOAD_DELAY': '2',
