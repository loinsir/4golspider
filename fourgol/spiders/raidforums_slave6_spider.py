...
logger = logging.getLogger('raidforums_slave6')


class RaidforumsSlave6Spider(RaidforumsSpider): # Category: RaidForums>OnlineAccounts>Gaming

    name = 'raidforumsslave6'
    custom_settings = {
        'DOWNLOAD_DELAY': '2',
